...
function buildQuestionsFromSnapshot(
    ...
    if(
        ...
        showMessage(
            "No normal questions available. Permanent location and photo questions are ready."
        );
...
function renderPhotoQuestion(
    ...
    note.textContent =
        "⚠️ चारों फोटो आवश्यक हैं। सभी फोटो चुनने के बाद आगे बढ़ें।";
